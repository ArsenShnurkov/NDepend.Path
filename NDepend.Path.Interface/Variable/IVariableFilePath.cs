namespace NDepend.Path.Interface.Variable
{
    ...
    public interface IVariableFilePath : IFilePath, IVariablePath
    {
        ...
        VariablePathResolvingStatus TryResolve(
            IEnumerable<KeyValuePair<string, string>> variablesValues,
            out IAbsoluteFilePath pathFileResolved,
    ...
    internal abstract class IVariableFilePathContract : IVariableFilePath
    {
        ...
        public VariablePathResolvingStatus TryResolve(
            IEnumerable<KeyValuePair<string, string>> variablesValues,
            out IAbsoluteFilePath pathFileResolved,
            out IReadOnlyList<string> unresolvedVariables)
        {
        ...
        public abstract VariablePathResolvingStatus TryResolve(
            IEnumerable<KeyValuePair<string, string>> variablesValues,
            out IAbsolutePath pathResolved,
            out IReadOnlyList<string> unresolvedVariables);
