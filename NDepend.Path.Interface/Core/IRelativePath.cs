namespace NDepend.Path.Interface.Core
{
    ...
    public interface IRelativePath : IPath
    {
        ...
        ///This method is hidden in <see cref="T:NDepend.Path.Interface.Core.IAbsoluteFilePath"/> and <see cref="T:NDepend.Path.Interface.Core.IAbsoluteDirectoryPath"/> to get a typed result.
